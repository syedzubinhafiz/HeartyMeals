...
export class Migration1724327529560 implements MigrationInterface {
    name = 'Migration1724327529560'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_allergies" ADD CONSTRAINT "FK_815358fe6393a9e4843b0441958" FOREIGN KEY ("user_id") REFERENCES "user"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_allergies" ADD CONSTRAINT "FK_641724b9a3fa9f98c0405339e00" FOREIGN KEY ("food_cat_id") REFERENCES "food_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_allergies" DROP CONSTRAINT "FK_641724b9a3fa9f98c0405339e00"`);
