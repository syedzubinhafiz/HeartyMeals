...
export class Migration1724336635189 implements MigrationInterface {
    name = 'Migration1724336635189'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_user_role_enum" AS ENUM('Admin', 'Patient', 'Dietitian')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."recipe_visibility_enum" AS ENUM('Private', 'Unlisted', 'Public')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."component_component_type_enum" AS ENUM('Ingredient', 'Seasoning')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."storage_type_enum" AS ENUM('jpeg', 'jpg', 'png', 'svg', 'mp4', 'mov', 'avi', 'mkv', 'wmv')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."component_component_type_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."recipe_visibility_enum"`);
