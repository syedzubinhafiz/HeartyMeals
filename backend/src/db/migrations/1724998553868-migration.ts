...
export class Migration1724998553868 implements MigrationInterface {
    name = 'Migration1724998553868'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" ADD "age" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "height" double precision NOT NULL`);
