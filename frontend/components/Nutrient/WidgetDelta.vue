<template>
    ...
    <Overlay level="1" class="space-y-4 z-10 rounded-xl shadow-xl">
        ...
        <NutrientBarDelta label="Calories" :valueBefore="nutrientData.calories" :valueAfter="netNutrientData.calories" :maxValue="maxNutrientData.calories" colorBefore="#D7D1B4" colorAfter="#B8B396" bgColor="#E9E5CD" icon="/assets/img/caloriesIcon.png"/>
