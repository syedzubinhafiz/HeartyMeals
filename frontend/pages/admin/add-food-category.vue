...
<template>
    ...
    <h1 class="title">Add New Food Category</h1>
    ...
    <div class="content-container">
        <form class="form-format" @submit.prevent>
            ...
            <div class="form-group">
                <label class="form-label-format" for="name">Food Category Name</label>
                <div></div>
...
const createNewCategory = async () => {
  ...
  try {
    ...
    const response = await $axios.post('/food_category/add', {
        foodCategoryName: document.getElementById('name').value,
    }, {
      headers: {
    ...
    if (response.data.type == document.getElementById('name').value) {
      useToast().success("Food Category added successfully!");
